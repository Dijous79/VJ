...
void Scene::init3()
{
	...
	bubble1 = new Bubble();
	bubble1->init(glm::ivec2(SCREEN_X, SCREEN_Y), texProgram, 5, 13 * map->getTileSize() - 3, true);
	bubble1->setPosition(glm::vec2(10 * map->getTileSize(), 13 * map->getTileSize() - 3));
	bubble1->setTileMap(map);
	bubbles.insert(bubble1);

	bubble2 = new Bubble();
	bubble2->init(glm::ivec2(SCREEN_X, SCREEN_Y), texProgram, 5, 13 * map->getTileSize() - 3, true);
	bubble2->setPosition(glm::vec2(16 * map->getTileSize(), 13 * map->getTileSize() - 3));
	bubble2->setTileMap(map);
	bubbles.insert(bubble2);

	bubble3 = new Bubble();
	bubble3->init(glm::ivec2(SCREEN_X, SCREEN_Y), texProgram, 5, 13 * map->getTileSize() - 3, false);
	bubble3->setPosition(glm::vec2(39 * map->getTileSize(), 13 * map->getTileSize() - 3));
	bubble3->setTileMap(map);
	bubbles.insert(bubble3);

	bubble4 = new Bubble();
	bubble4->init(glm::ivec2(SCREEN_X, SCREEN_Y), texProgram, 7, 1 * map->getTileSize()-2, true);
	bubble4->setPosition(glm::vec2(31 * map->getTileSize(), 1 * map->getTileSize() - 2));
